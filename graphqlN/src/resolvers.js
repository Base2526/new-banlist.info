    ...
    async updateUser(parent, args, context, info) {
      ...
      try{
        ...
        if(!_.isEmpty(input.files)){
          ...
          let pathName = path.join(__dirname,   `/app/uploads/${assetUniqName}`);
          pathName = `/app/uploads/${assetUniqName}`;
          ...
          for (let i = 0; i < input.files.length; i++) {
            try{
              ...
              if(!_.isEmpty(fileObject)){
                ...
                console.log("updatePost :", pathName)
...
export default {
  ...
  // commentAdded
>>>>>>> 559fb9a3ebf561f256d2eaf6bd474f98b219e565
};